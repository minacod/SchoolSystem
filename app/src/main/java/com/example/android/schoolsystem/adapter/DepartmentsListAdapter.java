...
import com.example.android.schoolsystem.data.SystemContract.DepartmentsEntry;
...
public class DepartmentsListAdapter extends RecyclerView.Adapter<DepartmentsListAdapter.ViewHolder>{
    ...
    public DepartmentsListAdapter(Cursor mClassRooms) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.itemView.setTag(mCursor.getInt(mCursor.getColumnIndex(DepartmentsEntry.DEPARTMENT_NO)));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(int itemNumber){
            ...
            mBinding.tvCrName.setText(mCursor.getString(mCursor.getColumnIndex(DepartmentsEntry.DEPARTMENT_NAME)));
            mBinding.tvCrCap.setText(String.valueOf(mCursor.getInt(mCursor.getColumnIndex(DepartmentsEntry.DEPARTMENT_NO))));
        }
